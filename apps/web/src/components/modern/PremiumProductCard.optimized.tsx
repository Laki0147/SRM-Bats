...
import { getImageSizes, getShimmerDataURL, imageQuality } from '@/lib/image-utils'
import { MotionDiv } from '@/components/dynamic-imports'
    ...
    >
      ...
      <div className="relative aspect-[4/5] overflow-hidden bg-gradient-to-br from-[#f9f7f4] to-[#f3efe8] rounded-t-[24px]">
        ...
        >
          <Image
            ...
            loading="lazy"
            placeholder="blur"
            blurDataURL={getShimmerDataURL(400, 500)}
      ...
      <div className="p-5">
        ...
        <div className="flex items-center gap-2 mb-3">
          <div className="flex items-center" role="img" aria-label={`Rating: ${rating} out of 5`}>
            {[...Array(5)].map((_, i) => (
              <Star
                key={i}
                className={`w-4 h-4 ${
